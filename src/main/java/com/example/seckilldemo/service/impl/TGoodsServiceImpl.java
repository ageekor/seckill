...
@Service
@Primary
public class TGoodsServiceImpl extends ServiceImpl<TGoodsMapper, GoodsVo> implements ITGoodsService {

    @Autowired
    private TGoodsMapper tGoodsMapper;

    @Override
    public List<GoodsVo> findTGoods() {
        return tGoodsMapper.findGoodsVo();
    }

    @Override
    public GoodsVo findTGoodsById(Long goodsId) {
